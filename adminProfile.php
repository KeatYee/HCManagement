...
if (!isset($_SESSION['admin'])) {
    ...
    $role =  $_SESSION['role'];
    $Adminssn = $_SESSION['Adminssn'];

    $sql = "SELECT * FROM Users WHERE ssn = '$Adminssn'";
...
<div class='acc'>
    ...
    <div class='accContainer'>
        <form class='accForm'>
            ...
            <input type='text' id='email' value='<?php echo $admin; ?>' readonly onclick="openEditForm('editEmailForm')">
...
<div id="editNameForm" class="edit-form-container">
  <div class="edit-form-content">
    ...
    <span class="close" onclick="closeEditForm('editNameForm')">&times;</span>
      <form action="adminProfile.php" method="post" id="editForm">
